...
Version  : 3.7.2
Release  : 48
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.7.2/swupd-server-3.7.2.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.7.2/swupd-server-3.7.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1511905645
