...
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.3.4/swupd-server-3.3.4.tar.gz
...
%prep
%setup -q -n swupd-server-3.3.4

%build
export LANG=C
export SOURCE_DATE_EPOCH=1491844701
