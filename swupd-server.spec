...
Version  : 3.3.1
Release  : 28
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.3.1/swupd-server-3.3.1.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.3.1/swupd-server-3.3.1.tar.gz
