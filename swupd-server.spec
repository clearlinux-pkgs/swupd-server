...
Version  : 3.3.3
Release  : 30
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.3.3/swupd-server-3.3.3.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.3.3/swupd-server-3.3.3.tar.gz
...
%prep
%setup -q -n swupd-server-3.3.3

%build
export LANG=C
export SOURCE_DATE_EPOCH=1491334396
