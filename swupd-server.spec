...
Version  : 3.5.0
Release  : 36
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.5.0/swupd-server-3.5.0.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.5.0/swupd-server-3.5.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1501312109
