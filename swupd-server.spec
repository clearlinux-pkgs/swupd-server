...
Version  : 3.3.5
Release  : 33
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.3.5/swupd-server-3.3.5.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.3.5/swupd-server-3.3.5.tar.gz
...
%prep
%setup -q -n swupd-server-3.3.5

%build
export LANG=C
export SOURCE_DATE_EPOCH=1492459661
