...
Version  : 3.1.0
Release  : 10
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.1.0/swupd-server-3.1.0.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.1.0/swupd-server-3.1.0.tar.gz
