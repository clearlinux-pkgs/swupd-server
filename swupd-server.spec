...
Version  : 3.3.2
Release  : 29
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.3.2/swupd-server-3.3.2.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.3.2/swupd-server-3.3.2.tar.gz
