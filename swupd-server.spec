...
Version  : 3.7.3
Release  : 49
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.7.3/swupd-server-3.7.3.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.7.3/swupd-server-3.7.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1512426023
