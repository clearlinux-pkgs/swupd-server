...
Version  : 3.0.0
Release  : 9
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.0.0/swupd-server-3.0.0.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.0.0/swupd-server-3.0.0.tar.gz
