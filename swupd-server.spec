...
Version  : 3.1.1
Release  : 11
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.1.1/swupd-server-3.1.1.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.1.1/swupd-server-3.1.1.tar.gz
