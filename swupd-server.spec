...
Version  : 3.2.1
Release  : 14
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.2.1/swupd-server-3.2.1.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.2.1/swupd-server-3.2.1.tar.gz
