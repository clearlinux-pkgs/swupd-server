...
Version  : 3.2.8
Release  : 24
URL      : https://github.com/clearlinux/swupd-server/releases/download/v3.2.8/swupd-server-3.2.8.tar.gz
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.2.8/swupd-server-3.2.8.tar.gz
