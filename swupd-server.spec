...
Source0  : https://github.com/clearlinux/swupd-server/releases/download/v3.7.4/swupd-server-3.7.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1512505964
